    ...
    <div id="wrapper">
        <div id="wrapperInner">
            <div id="topBar">
                ...
                <a href="hotel/1/6/4" class="itemNext">全部</a>
                <a href="hotel/1/6/4,7" class="itemNext">南坪</a>
                <a href="hotel/1/6/4,8" class="itemIndex">解放碑</a>
                <a href="hotel/1/6/4,9" class="itemIndex">观音桥</a>
            </div>
            <div id="content">
