...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/hotelView.css">
    ...
    <div id="wrapper">
        <div id="wrapperInner">
            <div id="topBar">
                ...
                <div id="storeDesc">
                    <div id="storeSpeed" class="commentStar1">服务态度
                    </div>
                    <div id="storeComment" class="commentStar4">总体评价</div>
                </div>
                <a href="play/1/6/2,10" class="itemNext">全部</a>
                <a href="play/1/6/2,10,7" class="itemNext">南坪</a>
                <a href="play/1/6/2,10,8" class="itemIndex">解放碑</a>
                <a href="play/1/6/2,10,9" class="itemIndex">观音桥</a>
            </div>
            <div id="content">
