...
<body>
    <div id="wrapper">
        <div id="wrapperInner">
            <div id="topBar">
                <span id="itemType">外卖</span>
                <a href="food/<%= (currentPage - 1) + "/" + amount%>" id="itemPrev" <%= currentPage - 1 < 1 ? "style=\"display:none\"" : ""%>>上一页</a>
                <a href="food/<%= (currentPage + 1) + "/" + amount%>" id="itemNext" <%= currentPage + 1 > (int) Math.ceil((double) total/amount) ? "style=\"display:none\"" : ""%>>下一页</a>
