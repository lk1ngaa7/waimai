...
<body>
    <div id="wrapper">
        <div id="wrapperInner">
            <div id="topBar">
                <a id="itemType" href="houseIndex.html">住宿</a>
                <a href="house/<%= (currentPage - 1) + "/" + amount%>/3" id="itemPrev" <%= currentPage - 1 < 1 ? "style=\"display:none\"" : ""%>>上一页</a>
                <a href="house/<%= (currentPage + 1) + "/" + amount%>/3" id="itemNext" <%= currentPage + 1 > (int) Math.ceil((double) total/amount) ? "style=\"display:none\"" : ""%>>下一页</a>
